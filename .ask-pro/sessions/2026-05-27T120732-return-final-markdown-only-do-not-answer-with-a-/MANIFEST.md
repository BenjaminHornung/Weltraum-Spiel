...
Session: `2026-05-27T120732-return-final-markdown-only-do-not-answer-with-a-`
...
- `Assets/Scripts/Prototype/MainThrusterBank.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/MainThrusterModule.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/ModuleMassDescriptor.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypeImportedShipBinder.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypePlayerHud.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypeShipConfig.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypeTrajectoryPlanner.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypeTrajectoryPreviewNavMap.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/PrototypeWaypointAutopilot.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/RcsThrusterController.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/ShipPhysicsCore.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/ShipStats.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/TrajectoryBurnPlan.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/TrajectoryPredictionState.cs` - Matched by --files pattern.
- `Assets/Scripts/Prototype/TrajectoryPredictor.cs` - Matched by --files pattern.
- `Assets/Tests/Editor/PrototypeWaypointAutopilotValidationTests.cs` - Matched by --files pattern.
- `Assets/Tests/Editor/TrajectoryPreviewPredictionTests.cs` - Matched by --files pattern.
