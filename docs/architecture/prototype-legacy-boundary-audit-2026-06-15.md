...
This audit defines the line between the current Prototype runtime and the future Clean Core product architecture. It is based on the current prototype state, the clean-core architecture docs, roadmap sequencing, the planning-consistency audit, and the current prototype proving-ground evidence (`docs/current-prototype-state.md:7-16, 48-64, 65-157`; `docs/architecture/clean-core-refactor-overview.md:10-22, 43-55`; `docs/architecture/clean-core-runtime-architecture.md:53-62, 63-121, 208-213`; `docs/roadmap/milestones.md:25-43, 45-64, 85-103, 161-178`; `docs/roadmap/spec-sorting-2026-06-15.md:21-84`; `docs/design-audits/2026-06-14-planning-consistency-audit.md:61-85, 137-220`).
