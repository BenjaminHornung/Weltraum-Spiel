...
| Change | Status | Evidence | Blocker | Recommendation | Next Action |
| --- | --- | --- | --- | --- | --- |
| `fix-autopilot-exact-point-arrival-v1` | Complete | Yes (test-protocol, acceptance gate PASS) | None | Archive Candidate | Reconcile `docs/legacy-unity/current-prototype-state-2026-06-15.md` (done), then run preflight and archive. |
