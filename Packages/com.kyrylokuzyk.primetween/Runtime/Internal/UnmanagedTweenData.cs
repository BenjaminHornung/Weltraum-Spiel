...
namespace PrimeTween {
    ...
    internal struct UnmanagedTweenData {
        ...
        internal bool CallbackDirectionEnabled {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => GetFlag(Flags.CallbackDirectionEnabled);
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => SetFlag(Flags.CallbackDirectionEnabled, value);
        }
        internal bool CallbackDirectionForward {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => GetFlag(Flags.CallbackDirectionForward);
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => SetFlag(Flags.CallbackDirectionForward, value);
        }
        internal bool CallbackDirectionBackward {
            [MethodImpl(MethodImplOptions.AggressiveInlining)] get => GetFlag(Flags.CallbackDirectionBackward);
            [MethodImpl(MethodImplOptions.AggressiveInlining)] set => SetFlag(Flags.CallbackDirectionBackward, value);
        }
