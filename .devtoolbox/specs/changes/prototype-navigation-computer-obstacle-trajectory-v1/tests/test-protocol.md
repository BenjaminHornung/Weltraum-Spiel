...
| Unity/EditMode tests | Pending | Run navigation/autopilot tests. |
...
- `tests/screenshots/navigation-no-obstacle.png`: Pending.
- `tests/screenshots/navigation-obstacle.png`: Pending.
- `tests/screenshots/navigation-arrival-hold.png`: Pending.
