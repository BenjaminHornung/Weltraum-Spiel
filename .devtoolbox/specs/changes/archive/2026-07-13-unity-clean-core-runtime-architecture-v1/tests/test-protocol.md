...
- `docs/legacy-unity/architecture/clean-core-refactor-overview.md`
...
- `docs/legacy-unity/agent-prompts/codex_autopilot_test_range_agent.md`
- `docs/legacy-unity/agent-prompts/codex_autopilot_v2_agent.md`
- `docs/legacy-unity/agent-prompts/codex_project_structure_agent.md`
- `docs/legacy-unity/agent-prompts/codex_spec_cleanup_agent.md`
- `docs/legacy-unity/agent-prompts/codex_ui_redesign_agent.md`
