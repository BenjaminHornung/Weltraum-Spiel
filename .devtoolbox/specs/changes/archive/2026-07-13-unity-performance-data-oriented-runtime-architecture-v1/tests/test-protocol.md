...
- Validate `docs/legacy-unity/performance/performance-runtime-architecture.md` exists and matches the same contract.

## Local evidence

- `docs/legacy-unity/performance/performance-runtime-architecture.md` created.
