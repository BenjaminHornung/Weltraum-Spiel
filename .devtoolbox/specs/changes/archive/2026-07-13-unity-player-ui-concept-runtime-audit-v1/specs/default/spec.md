...
The project SHALL provide an evidence matrix for `docs/legacy-unity/ux/player-facing-ui-concept-v0.md` sections 3-8 that maps each v0 player-facing UI requirement to current implementation and verification evidence.
