...
Audit and tighten the current Player HUD against `docs/legacy-unity/ux/player-facing-ui-concept-v0.md` sections 3-8. This continuation also fixed two runtime UX regressions found during visual inspection:
