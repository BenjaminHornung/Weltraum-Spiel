...
| `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` L15-25 | Testpfade |
| `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` L47-64 | Pflichtfälle |
| `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` L66-81 | Evaluierte Metriken |
| `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` L122-136 | Evidence-Format |
| `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` L188-199 | Migration aus Proving Ground |
