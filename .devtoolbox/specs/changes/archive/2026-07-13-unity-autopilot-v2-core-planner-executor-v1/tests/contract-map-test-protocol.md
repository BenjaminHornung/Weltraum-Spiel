...
| 11 | `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` | L15-25 | Testpfade (RoutePlannerDirectTests, ObstacleTests, FuelTests, etc.) |
| 12 | `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` | L47-64 | Pflichtfälle (Direct_100m, TargetInsidePlanet, ObstacleCorridor, NoRcsAuthority, etc.) |
| 13 | `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` | L66-81 | Evaluierte Metriken (finalPositionError, fuelUsed, planHash, replanCountMustBeZero) |
| 14 | `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` | L122-136 | Evidence-Format (JSON, CSV, Screenshots, Failures) |
| 15 | `docs/legacy-unity/architecture/autopilot-v2-test-harness.md` | L188-199 | Migration aus Proving Ground (Phase 1-4) |
| 16 | `docs/legacy-unity/current-prototype-state-2026-06-15.md` | L105-110 | Exact-Arrival-Status: 0.20m-0.52m, specs_validate PASS |
| 17 | `docs/legacy-unity/current-prototype-state-2026-06-15.md` | L128-157 | Done-State für exact-point-arrival, Proving-Ground-Evidence |
...
Quelle: `docs/legacy-unity/current-prototype-state-2026-06-15.md` L128-157 und
