...
- Runtime: 30.20s across 0 frames (0.0 fps observed in editor PlayMode).
...
- Profiler GC recorder: active; max recorded GC allocated in frame: 1448670 bytes.
- Profiler main-thread recorder: active; max sample: 100859200 ns.
