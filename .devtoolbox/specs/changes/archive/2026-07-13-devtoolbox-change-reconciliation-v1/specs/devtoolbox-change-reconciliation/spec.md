...
`docs/legacy-unity/roadmap/spec-sorting-2026-06-15.md` that lists every active
...
`docs/legacy-unity/roadmap/stale-metadata-backlog-2026-06-15.md` that records:
...
`docs/legacy-unity/current-prototype-state-2026-06-15.md` MUST NOT contradict the passing exact-arrival
