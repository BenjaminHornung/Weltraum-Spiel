...
(`docs/legacy-unity/current-prototype-state-2026-06-15.md`) contradicts fresh evidence for the exact-arrival
...
1. `docs/legacy-unity/roadmap/spec-sorting-2026-06-15.md` - groups all active changes, their
   status, evidence, blockers, recommendations, and next actions.
2. `docs/legacy-unity/roadmap/stale-metadata-backlog-2026-06-15.md` - lists contradictory docs,
   stale task checkboxes, evidence-without-tasks, tasks-green-without-validation,
   and superseded changes.
3. An updated `docs/legacy-unity/current-prototype-state-2026-06-15.md` that resolves the exact-arrival
...
- Updating `docs/legacy-unity/current-prototype-state-2026-06-15.md` because exact-arrival evidence is
  unambiguous.
...
- `docs/legacy-unity/roadmap/spec-sorting-2026-06-15.md` exists and covers all active changes.
- `docs/legacy-unity/roadmap/stale-metadata-backlog-2026-06-15.md` exists.
- Exact-arrival contradiction in `docs/legacy-unity/current-prototype-state-2026-06-15.md` is resolved.
