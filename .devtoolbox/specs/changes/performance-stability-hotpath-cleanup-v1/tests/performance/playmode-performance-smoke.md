...
- Runtime: 30.04s across 9341 frames (311.0 fps observed in editor PlayMode).
...
- Profiler GC recorder: active; max recorded GC allocated in frame: 1374141 bytes.
- Profiler main-thread recorder: active; max sample: 36024500 ns.
