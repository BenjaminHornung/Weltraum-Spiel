...
- Runtime: 30.04s across 9635 frames (320.7 fps observed in editor PlayMode).
...
- Profiler GC recorder: active; max recorded GC allocated in frame: 1374387 bytes.
- Profiler main-thread recorder: active; max sample: 34331500 ns.
