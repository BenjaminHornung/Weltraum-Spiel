...
## Motivation
- The prototype is still the current playable authority for flight, autopilot, HUD, map, camera, combat, and ship binding behavior (`docs/current-prototype-state.md:7-16, 48-64, 65-157`).
- The architecture docs already require a controlled Clean-Core split with `Assets/_Weltraum` as the future product root and `Prototype` as legacy/reference (`docs/architecture/clean-core-refactor-overview.md:10-22, 43-55`; `docs/architecture/clean-core-runtime-architecture.md:53-62, 63-121, 208-213`).
...
- `.devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/specs/prototype-legacy-boundary/spec.md`
- `.devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/tasks.md`
- `.devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/tests/test-protocol.md`
