...
| --- | --- | --- |
| 6 | Review the authoritative prototype, architecture, roadmap, and audit docs. | `tests/test-protocol.md` lists the read project guidance and evidence pack; `docs/architecture/prototype-legacy-boundary-audit-2026-06-15.md` records the source docs used. |
...
| 11 | Create the docs/architecture audit report with the classification table and boundary rules. | `docs/architecture/prototype-legacy-boundary-audit-2026-06-15.md` exists and contains both sections. |
| 12 | Create the OpenSpec-style spec file for the Prototype legacy boundary. | `.devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/specs/prototype-legacy-boundary/spec.md` exists and defines the capability requirements. |
| 13 | Create this change's test protocol document. | `.devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/tests/test-protocol.md` exists. |
