...
After all task gates pass, create exactly #WELTRAUM-000 Add browser IndexedDB save repository core and push only feature/browser-indexeddb-save-repository-core-v1. Do not create a PR, merge, force-push, or touch another worktree.