...
- `analysis/browser-multi-obstacle-route-planner-v1-plan.md`
- `analysis/browser-multi-obstacle-route-planner-v1-scenario-requirements.json`
- `analysis/browser-multi-obstacle-route-planner-v1-implementation-map.md`
