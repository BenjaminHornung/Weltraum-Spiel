...
- `.devtoolbox/specs/change-audit-2026-06-14.md` - prior audit classifications.
- `docs/current-prototype-state.md` - documentation truth.
- `docs/design-audits/2026-06-14-planning-consistency-audit.md` - design gaps.
- `docs/roadmap/milestones.md` - milestone ordering.
- `docs/roadmap/spec-sorting-backlog.md` - prior backlog grouping.
...
The prior `docs/current-prototype-state.md` "Known Current Autopilot Blocker"
