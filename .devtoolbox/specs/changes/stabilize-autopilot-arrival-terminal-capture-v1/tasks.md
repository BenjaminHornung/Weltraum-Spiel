...
- [x] 2. Add terminal capture gate and taper/release envelope plan
...
- [x] 4. Add PlayMode and DirectFastTransfer regression evidence
...
- [x] 5. Final review and validation
