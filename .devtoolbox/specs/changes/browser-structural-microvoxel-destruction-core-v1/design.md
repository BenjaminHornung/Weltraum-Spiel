...
- branch: `feature/browser-adaptive-microvoxel-authority-v1`;
- exact dependency SHA: `5fb372bdba677e43e71566121c53efb5e244b93a`;
...
World Generation, package/lock/Vite/Playwright configuration, `.github/**`,
`infra/**`, and foreign agent changes. No package or E2E-group change is
allowed.
...
revision, the smallest canonical global occupied-cell key, and component
content hash. It is not traversal- or array-order identity; A-B-A means
rehydrating the same stored A revision, not reversing a monotone revision.

Mass is computed from cells, never from mesh output. Each cell has
