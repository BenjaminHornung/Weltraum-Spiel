...
1. **Planner-Fenster ist ein Debug-Dump.** Der Body besteht aus ~11 Zeilen Rohtelemetrie ("Authority: Flight plan emitted | executor pending | rev 122", "Plan: trajectory--520--120-3000-Burn rev 122 | Samples 470", "Track: pos 0.0m | cross 0.0m | sample 36", "Cmd: accel 0.01m/s2 | dot 0.00"). Das verletzt die eigenen Konzept-Docs (`docs/player-facing-ui-concept-v0.md` §3.2 "Nicht anzeigen", `docs/spielkonzept/navigation-computer.md` §16).
