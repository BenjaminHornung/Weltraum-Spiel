...
## Source Draft
This design builds on `docs/architecture/scene-management-v1.md` and `docs/architecture/clean-core-runtime-architecture.md`. The first source defines the scene categories and the existing validation intent; the second source defines the clean-core boundary that scenes must respect.
