...
- `docs/architecture/scene-registry-and-manifest-v1.md`
...
```text
 ...
 M .devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/tasks.md
?? .devtoolbox/specs/changes/prototype-legacy-boundary-audit-v1/tests/closeout-test-protocol.md
