...
/**
 * Test seam only: canonical PG-TRAGWERK-01 fixture seeding is shared by Vitest
 * and the browser proof, but is never part of the product module graph.
 */
...
/** Geschlossenes authored Fixture mit expliziter bekannter Aussenluft (7 Bricks, 27 Zellen). */
