...
export const HESTIA_PULSE_CUTTER_MAXIMUM_ENERGY_JOULES = 240;
export const HESTIA_PULSE_CUTTER_ENERGY_RECOVERY_DELAY_SECONDS = 3;
export const HESTIA_PULSE_CUTTER_ENERGY_RECOVERY_JOULES_PER_SECOND = 12;
