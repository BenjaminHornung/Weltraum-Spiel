...
export const STRUCTURAL_FRAGMENT_SCHEMA_VERSION = "structural-microvoxel-fragment-v1" as const;
export const STRUCTURAL_FRAGMENT_ID_VERSION = "structural-microvoxel-fragment-id-v1" as const;
...
export const STRUCTURAL_MAX_PROOF_DIGESTS = 4_096 as const;
export const STRUCTURAL_MAX_MATERIAL_TAGS = 256 as const;
export const STRUCTURAL_MAX_MATERIAL_FILTER_IDS = 4_096 as const;
export const STRUCTURAL_MAX_MATERIAL_DEFINITIONS = 4_096 as const;
export const STRUCTURAL_MAX_MATERIAL_BINDINGS = 4_096 as const;
export const STRUCTURAL_MAX_BRICKS = 4_096 as const;
export const STRUCTURAL_MAX_BRICK_CELLS = 4_096 as const;
export const STRUCTURAL_MAX_ANCHORS = 4_096 as const;
...
export type StructuralFragmentId = string & { readonly [structuralBrand]: "StructuralFragmentId" };
...
export interface StructuralConnectivityBudgets {
  readonly maxVisitedCells: number;
  readonly maxComponents: number;
  readonly maxIndexedFacts: number;
}

export interface StructuralFragment {
  readonly schemaVersion: typeof STRUCTURAL_FRAGMENT_SCHEMA_VERSION;
  readonly fragmentIdVersion: typeof STRUCTURAL_FRAGMENT_ID_VERSION;
...
export interface StructuralComponentClassification {
  ...
  readonly fragments: readonly StructuralFragment[];
}
...
export interface StructuralComponentMassBudgets extends StructuralMassBudgets {
  readonly maxConnectivityCells: number;
  readonly maxComponents: number;
  readonly maxConnectivityFacts: number;
}
