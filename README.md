...
The browser runtime does **not** yet provide full planets, voxel terrain, orbital mechanics, seamless surface transitions, production multiplayer, a playable ship-builder UI, persistent cargo gameplay, full combat, economy or missions.
...
apps/weltraum-browser/          Browser product mainline
  src/                          Runtime, flight, navigation, world, UI and Three.js adapter
...
Player-facing claims should be backed by tests and inspectable artifacts. Important current evidence includes:
