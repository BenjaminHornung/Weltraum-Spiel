...
- `Assets/Tests/PlayMode/PrototypeAutopilotProvingGroundPlayModeTests.cs`
  ...
  - Current source still has an explicit acceptance-gate marker for strict gameplay acceptance, which appears to drift from `docs/current-prototype-state.md`.
